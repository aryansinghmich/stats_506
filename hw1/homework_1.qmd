...
Cleaned the total expenses column to remove unwanted characters (~) and coerce into a numeric. Added NA to the empty entries in the expense columns. 
Dropped rows that had negative values in the expense columns. 
